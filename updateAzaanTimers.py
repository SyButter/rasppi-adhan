...
print("---------------------------------")
print("Dhur:")
addAzaanTime('dhuhr',times['dhuhr'],system_cron,get_command('dhuhr'), dry_run)
print("---------------------------------")
print("Asr:")
addAzaanTime('asr',times['asr'],system_cron,get_command('asr'), dry_run)
print("---------------------------------")
print("Maghrib:")
addAzaanTime('maghrib',times['maghrib'],system_cron,get_command('maghrib'), dry_run)
print("---------------------------------")
print("Isha:")
addAzaanTime('isha',times['isha'],system_cron,get_command('isha'), dry_run)
print("---------------------------------")
